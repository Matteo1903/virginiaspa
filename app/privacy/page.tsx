  ...
  return (
    <LegalShell title="Informativa privacy">
      ...
      <ul>
        ...
        <li>dati delle recensioni (valutazione, rituale scelto e testo inviato); l’indirizzo email non viene pubblicato;</li>
        <li>dati tecnici di navigazione (indirizzo IP, log di sicurezza) per il funzionamento del sito;</li>
        <li>metriche d’uso aggregate (pagine visitate e azioni sul sito) raccolte con PostHog Cloud EU in modalità cookieless, senza profili persistenti e senza dati di contatto.</li>
      </ul>
      ...
      <ul>
        ...
        <li><strong>Legittimo interesse</strong> (art. 6, lett. f): sicurezza del sito, prevenzione abusi, difesa in giudizio, e statistiche d’uso aggregate con PostHog Cloud EU per migliorare il sito.</li>
        <li><strong>Gestione delle recensioni</strong>: ricezione e verifica del contenuto richiesto dall’utente; l’eventuale pubblicazione avviene nel rispetto della volontà espressa dall’autore.</li>
        <li><strong>Consenso</strong> (art. 6, lett. a): solo se in futuro si attivassero cookie di profilazione o newsletter promozionali. Oggi il sito usa storage tecnico (tema e lingua) e PostHog in modalità cookieless.</li>
      </ul>

      <h2>4. Destinatari</h2>
      <p>I dati possono essere comunicati a: personale autorizzato della SPA; Stripe, Inc./Stripe Payments Europe per i pagamenti; Resend per l’invio delle email transazionali; Hostinger per hosting e database MySQL; PostHog Cloud EU per le statistiche d’uso aggregate, con dati ospitati a Francoforte. Non sono previste cessioni a fini di marketing a terzi.</p>
      ...
      <ul>
        ...
        <li>recensioni: per il tempo necessario alla verifica e all’eventuale pubblicazione, salvo richiesta di cancellazione;</li>
      ...
      <p>Ultimo aggiornamento: 21 settembre 2026.</p>
    </LegalShell>
  );
}
