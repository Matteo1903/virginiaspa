...
export function SiteHeader({ language, onLanguageChange, extraAction, showBooking = true }: { language: Language; onLanguageChange?: (language: Language) => void; extraAction?: ReactNode; showBooking?: boolean }) {
