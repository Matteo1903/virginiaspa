...
export default function CookiePage() {
  return (
    <LegalShell title="Cookie policy">
      ...
      <p>Il sito non installa cookie di profilazione o pubblicitari. Restano memorizzazioni tecniche, necessarie al funzionamento:</p>
      <ul>
      ...
      <h2>2. Statistiche d’uso (PostHog Cloud EU)</h2>
      <p>Le statistiche d’uso sono affidate a PostHog Cloud EU, con dati ospitati a Francoforte. Riceve pagine e azioni usate: visite, carrello, Gift Card, ritual finder, form contatti e avvio checkout. L’integrazione usa la modalità cookieless, non crea profili persistenti e non invia nome, email o telefono. Base giuridica: legittimo interesse (art. 6, lett. f GDPR) a migliorare il sito.</p>

      <h2>3. Pagamenti Stripe</h2>
      ...
      <h2>4. Cookie di terze parti futuri</h2>
      <p>Se in seguito si attivassero strumenti di misurazione con cookie (es. Google Analytics) o remarketing, questa pagina sarà aggiornata e, ove richiesto dalla normativa, verrà chiesto un consenso preventivo ed esplicito.</p>

      <h2>5. Come gestire lo storage</h2>
